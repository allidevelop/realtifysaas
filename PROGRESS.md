...
**Текущий фокус:** Этапы 1, 2, 4, 5 ✅ и Этап 6 (частично: дашборды/АРМ) готовы — все 6 платных модулей рабочие на демо-данных. Далее — Этап 3 (реальные данные), seats (этап 6), Этап 7 (прод).
