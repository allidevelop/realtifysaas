...
**Текущий фокус:** Этап 5 (биллинг/кабинет/платные модули) завершён ✅ (re-приоритизирован раньше 2–4 по решению владельца). Далее — наполнение модулей реальной логикой (этапы 2–4: гео/данные/оценка).
