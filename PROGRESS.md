...
**Текущий фокус:** Этапы 1, 2, 4, 5 ✅, Этап 6 (частично) и Этап 3 (ETL-конвейер на sample) готовы. Далее — реальные ключи OLX/Monobank/Telegram (владелец), seats, Этап 7 (прод).
...
## Этап 6 — Интерактивные отчёты и корпоративные функции 🟡 частично (дашборды есть; seats — нет)
