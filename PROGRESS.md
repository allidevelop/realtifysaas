...
**Текущий фокус:** Этапы 1, 2, 4, 5 ✅ готовы (на демо-данных для гео/оценки). Далее — Этап 3 (реальные данные/ETL: заменить синтетику реальным потоком объявлений) и Этап 6 (дашборды/корп), затем Этап 7 (прод).
